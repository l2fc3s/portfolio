...
export const ProjectData = [
...

  {
    ...
    title: "Java TechJobs",
    image: TechJobsImage,
    text: "This is a project done in LaunchCode LC101.  I contributed by connecting the application to a MySQL database. I also Implemented features that allow the user to add a new job, employer, and skills to the web application and database. The user can also search for specific jobs, employers, or skills. Search results will show in a list, or the user can filter jobs by category.",
    alt: "Java TechJobs",
